      ...
      <form className="mt-auto grid gap-1.5">
        ...
        {atCap ? (
          ...
          <SubmitButton
            ...
            pendingText="רוכש..."
          >
            +{BOOST_STEP_PCT}% · {BOOST_STEP_COST} 💎
          </SubmitButton>
        )}
      </form>
...
function CitySpellCard() {
  return (
    <div className="panel-inset flex flex-col gap-2 rounded-lg p-4 opacity-80">
      ...
      <span className="mt-auto rounded-lg border border-gold/30 bg-gold/5 px-3 py-2 text-center text-xs font-semibold text-gold">
        ✨ בקרוב
      </span>
    </div>
  );
...
export function DiamondShop({
  ...
  return (
    <div className="space-y-8">
      <section>
        <SectionTitle icon="⛏️" title="בונוס תפוקת משאבים" hint="עד +200% לכל משאב · 24ש׳" />
      ...
      <section>
        <SectionTitle icon="⏳" title="חבילות תורות" />
      ...
      <section>
        <SectionTitle icon="✨" title="קסמים ושירותים" />
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
